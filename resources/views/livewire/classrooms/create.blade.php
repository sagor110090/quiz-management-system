    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{__('Create New Classroom')}}</h5>
           ...
           <div class="modal-body">
            ...
            <div class="form-group mt-3">
                ...
                <input wire:model="classroom_unique_id" readonly type="text" class="form-control" id="classroom_unique_id" placeholder="{{__('Classroom Unique Id')}}">@error('classroom_unique_id') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
